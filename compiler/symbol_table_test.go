...
func TestDefine(t *testing.T) {
	expected := map[string]Symbol{
		...
		"c": {Name: "c", Scope: GlobalScope, Index: 0},
		"d": {Name: "d", Scope: GlobalScope, Index: 1},
		"e": {Name: "e", Scope: GlobalScope, Index: 0},
		"f": {Name: "f", Scope: GlobalScope, Index: 1},
	}
...
func TestResolveUnresolvableFree(t *testing.T) {
	...
	for _, name := range expectedUnresolved {
